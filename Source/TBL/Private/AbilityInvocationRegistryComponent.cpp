...
void UAbilityInvocationRegistryComponent::ClientTargetMethodEvent_Implementation(int32 InvocationId, FName TargetMethodName, ETargetMethodEvent::Type Event, FVector Location, const TArray<AActor*>& HitTargets) {
}
